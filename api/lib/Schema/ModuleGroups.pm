package Schema::ModuleGroups; #A table/row class
use 5.010001;
use strict;
use warnings;
use utf8;
...
A class for TABLE module_groups in schema db_Intranet2017
...
Each column from table C<module_groups> has an accessor method in this class.
